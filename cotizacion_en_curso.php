...
cotizacion_detalle_temporal.cotizacion_detalle_numero_piezas_temporal, cotizacion_detalle_temporal.cotizacion_detalle_mano_obra,
(((precio)+(cotizacion_detalle_incremento_temporal))*(cotizacion_detalle_numero_piezas_temporal))+(cotizacion_detalle_mano_obra)
AS costo_parcial
...
<html> 
	...
	<link href="https://cdn.datatables.net/r/ 
	bs-3.3.5/jq-2.1.4,dt-1.10.8/datatables.min.css" rel="stylesheet" type= 
	"text/css"/>
	...
	<body> 
		<!--cadigo que incluye el menu responsivo--> 
		<?php include'inc/incluye_menu.php' ?>
	<div class="container">
	<div class="jumbotron">
	<div class="h3">
	La cotizaci&oacute;n en curso contene la siguiente informaci&oacute;n:<br>
	...
	<div class="h2">
	<p> <a href="refacciones_seleccionar_marca.php" class="btn btn-primary" role="buton">Añadir más refacciones</a></p>
	<p> <a href="cotizacion_imprimir.php" target="_blank" class="btn btn-info" role="buton">Imprimir esta cotizacionn</a></p>
	<p> <a href="cotizacion_guardar.php" class="btn btn-success" role="buton">Guardar esta cotizacion</a></p>
	<p> <a href="cotizacion_eliminar.php" class="btn btn-danger" role="buton">Eliminar esta cotizacion</a></p>
	</div>
	</div>
